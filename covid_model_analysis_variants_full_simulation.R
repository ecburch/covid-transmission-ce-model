...
# Run first in base case variant scenario
...
mean_yearly_deaths_plot_base_case <- ggplot(data = df_mean_yearly_deaths, aes(x = Strategy, y = Deaths)) +
...
print(mean_yearly_deaths_plot_base_case)

ggsave(path = "Results/Variant scenarios/", filename = paste0(as.character(Sys.Date()), " Plot 1. Mean yearly deaths_base_case.jpeg"), 
       plot = mean_yearly_deaths_plot_base_case, width = 8, height = 5)
...
cef_plot_base_case <- ggplot(data = cef_data_means, aes(x = effectiveness, y = cost, colour = dominant, label = strategy)) +
  geom_point() +
...
print(cef_plot_base_case)

ggsave(path = "Results/Variant scenarios/", filename = paste0(as.character(Sys.Date()), " Plot 2. Cost-effectiveness frontier_base_case.jpeg"),
       plot = cef_plot_base_case, width = 8, height = 6)
...
cost_effectiveness_acceptability_curve_base_case <- ggplot(prob_cost_effective, aes(x = Threshold, y = Probability, colour = Scenario)) + 
...
print(cost_effectiveness_acceptability_curve_base_case)

ggsave(path = "Results/Variant scenarios/", filename = paste0(as.character(Sys.Date()), " Plot 4. Cost effectiveness acceptability curve_base_case.jpeg"), 
       plot = cost_effectiveness_acceptability_curve_base_case, width = 8, height = 5)
...
ranked_strategies_plot_base_case <- ggplot(df_disease_averted_rank, aes(x = Rank, y = Names, colour = Outcome_f, linetype = Outcome_f)) +
...
print(ranked_strategies_plot_base_case)

ggsave(path = "Results/Variant scenarios/", filename = paste0(as.character(Sys.Date()), " Plot 5. Ranked strategies by outcome_base_case.jpeg"), 
       plot = ranked_strategies_plot_base_case, width = 8, height = 6)

# Creating results table

colnames(results_merged) <- colnames(incremental_results_merged) <- 
  vacc_scenarios
...
write.xlsx((model_output), paste0("Results/Variant scenarios/", as.character(Sys.Date()), " Results table_base_case.xlsx"), rowNames = TRUE)


rm(list=setdiff(ls(), c("par_fit", "ranked_strategies_plot_base_case", "cef_plot_base_case", "cost_effectiveness_acceptability_curve_base_case", 
                        "mean_yearly_deaths_plot_base_case")))

# Run again for variant scenario 2
...
df_mean_yearly_deaths <- data.frame(Deaths = mean_yearly_deaths, Strategy = vacc_scenarios)
mean_yearly_deaths_plot_scenario_2 <- ggplot(data = df_mean_yearly_deaths, aes(x = Strategy, y = Deaths)) +
  geom_bar(stat = "identity") +
  geom_hline(aes(yintercept = deaths_data_total["Total"]), colour = "red", linewidth = 1.5, linetype = "dashed") +
  theme(legend.position = "none", 
        axis.text.x = element_text(hjust = 1, angle =  45, vjust = 1, size = 14),
...
print(mean_yearly_deaths_plot_scenario_2)

ggsave(path = "Results/Variant scenarios/", filename = paste0(as.character(Sys.Date()), " Plot 1. Mean yearly deaths_scenario_2.jpeg"), 
       plot = mean_yearly_deaths_plot_scenario_2, width = 8, height = 5)
...
cef_plot_scenario_2 <- ggplot(data = cef_data_means, aes(x = effectiveness, y = cost, colour = dominant, label = strategy)) +
  geom_point() +
  geom_line(data = cef_data_dominant, aes(x = effectiveness, y = cost, group = 1)) +
  labs(colour = "Dominant strategy?",
       x = "Incremental QALYs",
...
print(cef_plot_scenario_2)

ggsave(path = "Results/Variant scenarios/", filename = paste0(as.character(Sys.Date()), " Plot 2. Cost-effectiveness frontier_scenario_2.jpeg"),
       plot = cef_plot_scenario_2, width = 8, height = 6)
...
cost_effectiveness_acceptability_curve_scenario_2 <- ggplot(prob_cost_effective, aes(x = Threshold, y = Probability, colour = Scenario)) + 
  geom_smooth(method = "loess", span = 0.1, se = FALSE) +
  labs(colour = "Vaccination strategy") +
  scale_color_manual(values = c(blue_12[4:12], green_12[4:12], red_12[4:12])) +
  theme(legend.title = element_text(size = 12), 
...
print(cost_effectiveness_acceptability_curve_scenario_2)

ggsave(path = "Results/Variant scenarios/", filename = paste0(as.character(Sys.Date()), " Plot 4. Cost effectiveness acceptability curve_scenario_2.jpeg"), 
       plot = cost_effectiveness_acceptability_curve_scenario_2, width = 8, height = 5)
...
ranked_strategies_plot_scenario_2 <- ggplot(df_disease_averted_rank, aes(x = Rank, y = Names, colour = Outcome_f, linetype = Outcome_f)) +
  geom_bump(linewidth = 1.5) +
  labs(x = "Rank (1 = best)",
       y = "Vaccination strategy",
       colour = "Outcome",
...
print(ranked_strategies_plot_scenario_2)

ggsave(path = "Results/Variant scenarios/", filename = paste0(as.character(Sys.Date()), " Plot 5. Ranked strategies by outcome_scenario_2.jpeg"), 
       plot = ranked_strategies_plot_scenario_2, width = 8, height = 6)
...
colnames(full_epi_results) <- colnames(full_ce_results) <- c("BASELINE, comparator", vacc_scenarios[-1])
model_output <- list("Epi results" = full_epi_results, "CE results" = full_ce_results, Parameters = par_fit)
write.xlsx((model_output), paste0("Results/Variant scenarios/", as.character(Sys.Date()), " Results table_scenario_2.xlsx"), rowNames = TRUE)


rm(list=setdiff(ls(), c("par_fit", "ranked_strategies_plot_base_case", "cef_plot_base_case", "cost_effectiveness_acceptability_curve_base_case", 
                        "mean_yearly_deaths_plot_base_case", "ranked_strategies_plot_scenario_2", "cef_plot_scenario_2", 
                        "cost_effectiveness_acceptability_curve_scenario_2", "mean_yearly_deaths_plot_scenario_2")))

# Run again for variant scenario 3
...
df_mean_yearly_deaths <- data.frame(Deaths = mean_yearly_deaths, Strategy = vacc_scenarios)
mean_yearly_deaths_plot_scenario_3 <- ggplot(data = df_mean_yearly_deaths, aes(x = Strategy, y = Deaths)) +
  geom_bar(stat = "identity") +
  geom_hline(aes(yintercept = deaths_data_total["Total"]), colour = "red", linewidth = 1.5, linetype = "dashed") +
  theme(legend.position = "none", 
        axis.text.x = element_text(hjust = 1, angle =  45, vjust = 1, size = 14),
...
print(mean_yearly_deaths_plot_scenario_3)

ggsave(path = "Results/Variant scenarios/", filename = paste0(as.character(Sys.Date()), " Plot 1. Mean yearly deaths_scenario_3.jpeg"), 
       plot = mean_yearly_deaths_plot_scenario_3, width = 8, height = 5)
...
cef_plot_scenario_3 <- ggplot(data = cef_data_means, aes(x = effectiveness, y = cost, colour = dominant, label = strategy)) +
  geom_point() +
  geom_line(data = cef_data_dominant, aes(x = effectiveness, y = cost, group = 1)) +
  labs(colour = "Dominant strategy?",
       x = "Incremental QALYs",
...
print(cef_plot_scenario_3)

ggsave(path = "Results/Variant scenarios/", filename = paste0(as.character(Sys.Date()), " Plot 2. Cost-effectiveness frontier_scenario_3.jpeg"),
       plot = cef_plot_scenario_3, width = 8, height = 6)
...
cost_effectiveness_acceptability_curve_scenario_3 <- ggplot(prob_cost_effective, aes(x = Threshold, y = Probability, colour = Scenario)) + 
  geom_smooth(method = "loess", span = 0.1, se = FALSE) +
  labs(colour = "Vaccination strategy") +
  scale_color_manual(values = c(blue_12[4:12], green_12[4:12], red_12[4:12])) +
  theme(legend.title = element_text(size = 12), 
...
print(cost_effectiveness_acceptability_curve_scenario_3)

ggsave(path = "Results/Variant scenarios/", filename = paste0(as.character(Sys.Date()), " Plot 4. Cost effectiveness acceptability curve_scenario_3.jpeg"), 
       plot = cost_effectiveness_acceptability_curve_scenario_3, width = 8, height = 5)
...
ranked_strategies_plot_scenario_3 <- ggplot(df_disease_averted_rank, aes(x = Rank, y = Names, colour = Outcome_f, linetype = Outcome_f)) +
  geom_bump(linewidth = 1.5) +
  labs(x = "Rank (1 = best)",
       y = "Vaccination strategy",
       colour = "Outcome",
...
print(ranked_strategies_plot_scenario_3)

ggsave(path = "Results/Variant scenarios/", filename = paste0(as.character(Sys.Date()), " Plot 5. Ranked strategies by outcome_scenario_3.jpeg"), 
       plot = ranked_strategies_plot_scenario_3, width = 8, height = 6)
...
colnames(full_epi_results) <- colnames(full_ce_results) <- c("BASELINE, comparator", vacc_scenarios[-1])
model_output <- list("Epi results" = full_epi_results, "CE results" = full_ce_results, Parameters = par_fit)
write.xlsx((model_output), paste0("Results/Variant scenarios/", as.character(Sys.Date()), " Results table_scenario_3.xlsx"), rowNames = TRUE)


rm(list=setdiff(ls(), c("par_fit", "ranked_strategies_plot_base_case", "cef_plot_base_case", "cost_effectiveness_acceptability_curve_base_case", 
                        "mean_yearly_deaths_plot_base_case", "ranked_strategies_plot_scenario_2", "cef_plot_scenario_2", 
                        "cost_effectiveness_acceptability_curve_scenario_2", "mean_yearly_deaths_plot_scenario_2",
                        "ranked_strategies_plot_scenario_3", "cef_plot_scenario_3", 
                        "cost_effectiveness_acceptability_curve_scenario_3", "mean_yearly_deaths_plot_scenario_3")))

# Run again for variant scenario 4
...
df_mean_yearly_deaths <- data.frame(Deaths = mean_yearly_deaths, Strategy = vacc_scenarios)
mean_yearly_deaths_plot_scenario_4 <- ggplot(data = df_mean_yearly_deaths, aes(x = Strategy, y = Deaths)) +
  geom_bar(stat = "identity") +
  geom_hline(aes(yintercept = deaths_data_total["Total"]), colour = "red", linewidth = 1.5, linetype = "dashed") +
  theme(legend.position = "none", 
        axis.text.x = element_text(hjust = 1, angle =  45, vjust = 1, size = 14),
...
print(mean_yearly_deaths_plot_scenario_4)

ggsave(path = "Results/Variant scenarios/", filename = paste0(as.character(Sys.Date()), " Plot 1. Mean yearly deaths_scenario_4.jpeg"), 
       plot = mean_yearly_deaths_plot_scenario_4, width = 8, height = 5)
...
cef_plot_scenario_4 <- ggplot(data = cef_data_means, aes(x = effectiveness, y = cost, colour = dominant, label = strategy)) +
  geom_point() +
  geom_line(data = cef_data_dominant, aes(x = effectiveness, y = cost, group = 1)) +
  labs(colour = "Dominant strategy?",
       x = "Incremental QALYs",
...
print(cef_plot_scenario_4)

ggsave(path = "Results/Variant scenarios/", filename = paste0(as.character(Sys.Date()), " Plot 2. Cost-effectiveness frontier_scenario_4.jpeg"),
       plot = cef_plot_scenario_4, width = 8, height = 6)
...
cost_effectiveness_acceptability_curve_scenario_4 <- ggplot(prob_cost_effective, aes(x = Threshold, y = Probability, colour = Scenario)) + 
  geom_smooth(method = "loess", span = 0.1, se = FALSE) +
  labs(colour = "Vaccination strategy") +
  scale_color_manual(values = c(blue_12[4:12], green_12[4:12], red_12[4:12])) +
  theme(legend.title = element_text(size = 12), 
...
print(cost_effectiveness_acceptability_curve_scenario_4)

ggsave(path = "Results/Variant scenarios/", filename = paste0(as.character(Sys.Date()), " Plot 4. Cost effectiveness acceptability curve_scenario_4.jpeg"), 
       plot = cost_effectiveness_acceptability_curve_scenario_4, width = 8, height = 5)
...
ranked_strategies_plot_scenario_4 <- ggplot(df_disease_averted_rank, aes(x = Rank, y = Names, colour = Outcome_f, linetype = Outcome_f)) +
  geom_bump(linewidth = 1.5) +
  labs(x = "Rank (1 = best)",
       y = "Vaccination strategy",
       colour = "Outcome",
...
print(ranked_strategies_plot_scenario_4)

ggsave(path = "Results/Variant scenarios/", filename = paste0(as.character(Sys.Date()), " Plot 5. Ranked strategies by outcome_scenario_4.jpeg"), 
       plot = ranked_strategies_plot_scenario_4, width = 8, height = 6)
...
colnames(full_epi_results) <- colnames(full_ce_results) <- c("BASELINE, comparator", vacc_scenarios[-1])
model_output <- list("Epi results" = full_epi_results, "CE results" = full_ce_results, Parameters = par_fit)
write.xlsx((model_output), paste0("Results/Variant scenarios/", as.character(Sys.Date()), " Results table_scenario_4.xlsx"), rowNames = TRUE)


# ALL SCENARIOS

# Plotting key plots for each variant scenario in a panel
